      ...
      <Card className="w-full max-w-md border-border/40 bg-card">
        ...
        <div className="p-6 space-y-4">
          ...
          >
            ...
            <p className="font-medium">Drag files/folders or click to browse</p>
            <p className="text-sm text-muted-foreground mt-1">Max 100MB per file • All types supported</p>
            <Input
              ref={fileInputRef}
              type="file"
              multiple
